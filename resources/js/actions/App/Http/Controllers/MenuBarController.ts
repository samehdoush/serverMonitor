...
/**
* @see \App\Http\Controllers\MenuBarController::focusMain
 * @see app/Http/Controllers/MenuBarController.php:28
 * @route '/menubar/focus'
 */
export const focusMain = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: focusMain.url(options),
    method: 'get',
})

focusMain.definition = {
    methods: ["get","head"],
    url: '/menubar/focus',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/menubar/focus'
 */
focusMain.url = (options?: RouteQueryOptions) => {
    return focusMain.definition.url + queryParams(options)
}
 ...
 * @route '/menubar/focus'
 */
focusMain.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: focusMain.url(options),
    method: 'get',
})
/**
 ...
 * @route '/menubar/focus'
 */
focusMain.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: focusMain.url(options),
    method: 'head',
})
 ...
 * @route '/menubar/focus'
 */
    const focusMainForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: focusMain.url(options),
        method: 'get',
    })
 ...
 * @route '/menubar/focus'
 */
        focusMainForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: focusMain.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/menubar/focus'
 */
        focusMainForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: focusMain.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
...
const MenuBarController = { index, focusMain, openServer, openSettings }
